...
Génération de la documentation Markdown dans TLP_RED_Instances_ABox.
"""
...
from config import ABOX_MASTER_PATH, DIR_INSTANCES_ABOX

def generate_abox_markdown():
    g = Graph()
    g.parse(str(ABOX_MASTER_PATH), format="turtle")
    
    # Destination du Markdown dans le dossier TLP:RED
    md_file = DIR_INSTANCES_ABOX / "DKG_ABox_Master.md"
    ...
    print(f"✅ Document Markdown généré sous : {md_file}")
