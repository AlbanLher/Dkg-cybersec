...
| Acronyme | Definition Complete | Description / Rôle dans le DKG |
| :--- | :--- | :--- |
...
| **CAPEC** | Common Attack Pattern Enumeration and Classification | Catalogues des schémas et tactiques d'attaque. |
| **SHACL** | Shapes Constraint Language | Langage de validation des structures de graphes RDF sous CWA. |
| **CWA** | Closed World Assumption | Hypothèse du monde clos (ce qui n'est pas exprimé est considéré faux). |
...
```mermaid
graph TD
    subgraph Infrastructure [Socle Système]
...
---
*Document généré automatiquement conformément aux exigences de livrables du projet DKG.*