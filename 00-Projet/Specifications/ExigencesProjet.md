...
* **`EXG-PROJ-11` (Etapes)** : Toutes activité doit identifier la phase ainsi que l'étape de la Phase. Les étapes sont : ( Cadrage, Specification, Donnees_source, Script-Test, Bilan ).  le cadre de cette activité contribue au contenu d'une phase décrite dans une instance du ./00-Projet/Phase_Content_Template.md
