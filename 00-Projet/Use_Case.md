...
## Les grandes lignes
Le cas d'usage est un individu avec un PC un roueteur et une Box FAI, qui met en place un Agent IA Cybersecurité.

Cas simple au début tant pour les equipements, logiciels parties prenantes et fonction cyber limitée à l'identification des vulnérabilités et recommandations d'action corrective.
