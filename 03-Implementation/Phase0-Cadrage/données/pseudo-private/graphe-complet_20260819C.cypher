...
UNWIND [{_id:2, properties:{uri:"http://example.org/cyber-ontology#Software"}}, {_id:3, properties:{uri:"http://example.org/cyber-ontology#requiresAction"}}, {_id:4, properties:{uri:"http://example.org/cyber-ontology#cvssScore"}}, {_id:5, properties:{uri:"http://example.org/cyber-ontology#Action"}}, {_id:6, properties:{uri:"http://example.org/cyber-ontology#hasVulnerability"}}, {_id:7, properties:{uri:"http://example.org/cyber-ontology#Device"}}, {_id:8, properties:{uri:"http://example.org/cyber-ontology#Threat"}}, {_id:9, properties:{uri:"http://example.org/cyber-ontology#hasSoftware"}}, {_id:10, properties:{uri:"http://example.org/cyber-ontology#Vulnerability"}}] AS row
...
UNWIND [{start: {_id:9}, end: {_id:7}, properties:{}}, {start: {_id:3}, end: {_id:10}, properties:{}}, {start: {_id:4}, end: {_id:10}, properties:{}}, {start: {_id:6}, end: {_id:7}, properties:{}}] AS row
MATCH (start:`UNIQUE IMPORT LABEL`{`UNIQUE IMPORT ID`: row.start._id})
MATCH (end:`UNIQUE IMPORT LABEL`{`UNIQUE IMPORT ID`: row.end._id})
